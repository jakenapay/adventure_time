    ...
    if(isset($_POST['submit'])){
        ...
        if(in_array($file_extension,$extension)){
            ...
            if($row['id'] == $id){
                ...
                header("Location: admindash-hotel.php?log=Edited Successfuly");
            }else{header("Location: admindash-hotel.php?log=No Hotel were edited");}
        }else{header("Location: admindash-hotel.php?log=Wrong file, Please try again");}
    }
