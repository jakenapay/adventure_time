...
form.addEventListener('submit', (e) => {
    ...
    if (firstname.value === '' || firstname.value == null ){
        ...
        Swal.fire(
          ...
          e.preventDefault()
    }else if(checkIfStringHasSpecialChar(firstname.value)){
        mes ="--------------Invalid Firstname--------------";
        Swal.fire(
            'Invalid Input',
            mes,
            'error',
    ...
    if (lastname.value === '' || lastname.value == null ){
      ...
      Swal.fire(
        ...
        e.preventDefault()
  }else if(checkIfStringHasSpecialChar(lastname.value)){
      mes ="--------------Invalid Firstname--------------";
      Swal.fire(
          'Invalid Input',
          mes,
