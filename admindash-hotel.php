...
<body>
  ...
  <div class="text">Manage</div>
    ...
    <div class="addbox">
        ...
        <form action="admindash-hotel-db-delete.php" method="post">
            <div class="input">
        ...
        <div class="editform">
            <form action="admindash-hotel-db-edit.php" method="post" enctype="multipart/form-data">
        ...
        <div class="editform">
            <form action="admindash-hotel-db-add.php" method="post" enctype="multipart/form-data">
