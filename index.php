        ...
        <div class="container">
            <a class="navbar-brand" href="#home"
                style="font-size: 30px; font-family: 'Nunito', sans-serif; color: white; font-weight: bold;"><img
                    ...
                    id="adventureLogo" style="color: #00fff2;">ADVENTURE</span>TIME</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="#"
                                    style="font-family: 'Nunito', sans-serif; font-size: 20px;">Hello, Guest!</a></li>
                            <li><a class="dropdown-item" href="loginpage.php"
                                    style="font-family: 'Nunito', sans-serif; font-size: 20px;">Log-in</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <form method="post" id="contact-form" role="form">
                ...
                <input type="submit" class="btn btn-outline-success" style="font-size: 16px;" value="send message"
                    name="ok">
